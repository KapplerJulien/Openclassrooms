...
Une fois créée, vous tombez directement dans la base, dans le menu de navigation en haut, appuyez sur "Importer", vous faites le chemin jusque dans le projet web et la base de données se trouve dans le dossier config.
...
Puis allez dans Wamp64 ou 32 tout dépend la version que vous avez pris. Puis dans www et vous mettez le projet ici.
Une fois mis ici, il suffit de retourner sur localhost dans votre page web. Puis il apparaitra dans "Vos projets", il suffira que cliquer dessus, puis de cliquer sur public.
