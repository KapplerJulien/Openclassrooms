...
foreach ($authorAccount as $parametre){
    // var_dump($parametre);
    // Modifier getter et setter de User.
    ?>
    
                <p>Votre nom : <?= htmlspecialchars($parametre['NomUtilisateur']);?></p>
                <p>Votre prénom : <?= htmlspecialchars($parametre['PrenomUtilisateur']);?></p>
                <p>Votre code postale : <?= htmlspecialchars($parametre['CodePostaleUtilisateur']);?></p>
                <p>Votre ville : <?= htmlspecialchars($parametre['VilleUtilisateur']);?></p>
                <p>Votre adresse mail : <?= htmlspecialchars($parametre['MailUtilisateur']);?></p>
